...
const About = () => {
  return (
    <div className="bg-patternMobile bg-cover bg-no-repeat bg-center md:bg-pattern bg-cover bg-no-repeat bg-center text-white min-h-screen flex flex-col justify-center items-center p-16 mt-10">
